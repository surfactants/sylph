...
struct BL_Node {
    ...
    BL_Node(const std::pair<int, int>& indices, double* sweep_line = nullptr, const std::vector<Point>* points = nullptr, BL_Node_ptr left = nullptr, BL_Node_ptr right = nullptr, BL_Node_ptr parent = nullptr, int height = 1);
