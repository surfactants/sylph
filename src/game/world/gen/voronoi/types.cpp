...
std::pair<Half_Edge_ptr, Half_Edge_ptr> Voronoi::makeTwins(int left, int right)
{
...
std::pair<Half_Edge_ptr, Half_Edge_ptr> Voronoi::makeTwins(const std::pair<int, int>& indices)
{
...
void Voronoi::connectHalfEdges(Half_Edge_ptr he1, Half_Edge_ptr he2)
{
    he1->next = he2;
    he2->prev = he1;
}
